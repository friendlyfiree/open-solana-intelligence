...
ok('challenge intake fails closed when no eligible evidence exists and names the exact target',
  app.includes('No public, approved evidence is linked to this Case or its winning Report version.')
    && app.includes("t('Target: Resolution {resolution} and its bound winning Report version {version}.'")
    && app.includes('resolution:resolution.public_ref')
    && app.includes("version:resolution.winning_report_version_ref||t('unavailable')"));
