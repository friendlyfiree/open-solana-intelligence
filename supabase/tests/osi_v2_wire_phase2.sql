...
insert into public.analyst_profiles (
  ...
  ('21111111111111111111111111111111','probationary_analyst','probationary',true,true,1.50,'wire_a','Wire analyst A'),
  ('31111111111111111111111111111111','probationary_analyst','probationary',true,true,1.50,'wire_b','Wire analyst B'),
  ('41111111111111111111111111111111','probationary_analyst','probationary',true,true,1.50,'wire_c','Wire analyst C');
