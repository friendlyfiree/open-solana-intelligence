...
**Authoritative entity count: 32 tables** — defined once in `OSI_V2_DOMAIN_MODEL.md §1` and referenced identically everywhere; no required entity is deferred "to implementation."
