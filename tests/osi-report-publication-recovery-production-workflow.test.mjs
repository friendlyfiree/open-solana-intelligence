...
const workflow = readFileSync(new URL(
  "../.github/workflows/archive/osi-report-publication-recovery-production.yml",
  import.meta.url,
), "utf8");
...
assert.match(workflow, /shellcheck --exclude=SC2317,SC2329 tests\/osi-v2-concurrency\.test\.sh/);
