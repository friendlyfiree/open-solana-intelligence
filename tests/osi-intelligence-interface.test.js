...
ok((index.match(/data-osi-route-style/g) || []).length === 10 && index.includes('./assets/js/02-route-styles.js'), 'route-only CSS is preloaded behind the shared activation guard');
