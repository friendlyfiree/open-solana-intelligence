...
matches(/NEW_VERSION: "20260802071500"/, "one migration version");
matches(/\$\{NEW_VERSION\}_osi_v2_report_rejection_transition\.sql/, "exact migration file");
matches(/BEFORE_VERSIONS:[\s\S]*20260801120700[\s\S]*AFTER_VERSIONS:[\s\S]*20260802071500/, "exact before and after histories");
